...
<nav class="navbar navbar-left" style="background-color: #081856!important; text-align: left;" role="navigation">
    <div class="container-fluid">
        <a class="navbar-brand d-flex flex-row" href="../verificar/inicioSesion.php">
            <img src="../img/loguito2.png" alt="" height="40" class="d-inline-block align-text-top">
            <h7 class="display-7 ms-4" style="color: #ffffff!important; font-family: 'Montserrat', sans-serif;"></h7>
        </a>
    </div>
</nav>