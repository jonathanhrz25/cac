      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-6 mb-3">
            <h5>Lenguajes</h5><br>
            <p>APACHE, HTML5, PHP, MySQL, JS, CSS, Bootstrap, etc.</p>
          </div>
          <div class="col-12 col-md-4 mb-3 text-start text-md-center">
            <h5>Proyecto</h5>
            <p>Encuestas CAC</p>
            <p>Consiste en realizar encuestas a clientes y la visualización de esos mismos datos, por medio de formularios y la creacion de graficas.</p>
          </div>
        </div>
      </div>
    </div>
