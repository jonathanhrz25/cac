        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <a href="../ejecutivasCac/bloque1.php" class="btn btn-outline-primary btn-lg btn-block">
                        Clientes Inactivos Contado "Bloque 1"
                    </a>
                </div>
                <div class="col-md-5 mx-auto">
                    <a href="../ejecutivasCac/bloque2.php" class="btn btn-outline-primary btn-lg btn-block">
                        Clientes Inactivos Contado "Bloque 2"
                    </a>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-5 mx-auto">
                    <a href="../ejecutivasCac/bloque3.php" class="btn btn-outline-primary btn-lg btn-block">
                        Clientes Inactivos Contado "Bloque 3"
                    </a>
                </div>
            </div>
        </div>
