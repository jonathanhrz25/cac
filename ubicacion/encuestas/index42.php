    ...
    <header>
        <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
            <div class="container-fluid">
                <a class="navbar-brand text-white" href="../rutas/ruta42.php">
            ...
            <div class="container col-md-12 col-12 mx-auto">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" role="group" aria-label="Pregunta apoyo">
                        <input type="radio" class="btn-check" name="apoyo" value="Vendedor" id="apoyo1" autocomplete="off">
                        <label class="btn btn-outline-primary" for="apoyo1">a) Vendedor</label>

                        <input type="radio" class="btn-check" name="apoyo" value="TLK" id="apoyo2" autocomplete="off">
                        <label class="btn btn-outline-primary" for="apoyo2">b) TLK</label>

                        <input type="radio" class="btn-check" name="apoyo" value="Ambos" id="apoyo3" autocomplete="off">
                        <label class="btn btn-outline-primary" for="apoyo3">c) Ambos</label>

                        <input type="radio" class="btn-check" name="apoyo" value="Pagina" id="apoyo4" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" role="group" aria-label="Pregunta frecuencia vendedor">
                        <input type="radio" class="btn-check" name="frecuencia_vende" value="Semanal" id="frecuencia1" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia1">Semanal</label>

                        <input type="radio" class="btn-check" name="frecuencia_vende" value="Quincenal" id="frecuencia2" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia2">Quincenal</label>

                        <input type="radio" class="btn-check" name="frecuencia_vende" value="Mensual" id="frecuencia3" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia3">Mensual</label>

                        <input type="radio" class="btn-check" name="frecuencia_vende" value="Mayor a 1 mes" id="frecuencia4" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia4">Mayor a 1 mes</label>

                        <input type="radio" class="btn-check" name="frecuencia_vende" value="No lo visitan" id="frecuencia5" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" role="group" aria-label="Pregunta frecuencia TLK">
                        <input type="radio" class="btn-check" name="frecuencia_tlk" value="Semanal" id="frecuencia_tlk1" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia_tlk1">Semanal</label>

                        <input type="radio" class="btn-check" name="frecuencia_tlk" value="Quincenal" id="frecuencia_tlk2" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia_tlk2">Quincenal</label>

                        <input type="radio" class="btn-check" name="frecuencia_tlk" value="Mensual" id="frecuencia_tlk3" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia_tlk3">Mensual</label>

                        <input type="radio" class="btn-check" name="frecuencia_tlk" value="Mayor a 1 mes" id="frecuencia_tlk4" autocomplete="off">
                        <label class="btn btn-outline-primary" for="frecuencia_tlk4">Mayor a 1 mes</label>

                        <input type="radio" class="btn-check" name="frecuencia_tlk" value="No le marcan" id="frecuencia_tlk5" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" role="group" aria-label="Pregunta reemplazo visita">
                        <input type="radio" class="btn-check" name="remplazar" value="Si" id="reemplazo1" autocomplete="off">
                        <label class="btn btn-outline-primary" for="reemplazo1">a) Si</label>

                        <input type="radio" class="btn-check" name="remplazar" value="No" id="reemplazo2" autocomplete="off">
                        <label class="btn btn-outline-primary" for="reemplazo2">b) No</label>

                        <input type="radio" class="btn-check" name="remplazar" value="Algunas veces" id="reemplazo3" autocomplete="off">
                        <label class="btn btn-outline-primary" for="reemplazo3">c) Algunas veces</label>

                        <input type="radio" class="btn-check" name="remplazar" value="Frecuentemente" id="reemplazo4" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" role="group" aria-label="Pregunta llamar TLK">
                        <input type="radio" class="btn-check" name="llamar" value="Si" id="llamar1" autocomplete="off">
                        <label class="btn btn-outline-primary" for="llamar1">a) Si</label>

                        <input type="radio" class="btn-check" name="llamar" value="No" id="llamar2" autocomplete="off">
                        <label class="btn btn-outline-primary" for="llamar2">b) No</label>

                        <input type="radio" class="btn-check" name="llamar" value="Algunas veces" id="llamar3" autocomplete="off">
                        <label class="btn btn-outline-primary" for="llamar3">c) Algunas veces</label>

                        <input type="radio" class="btn-check" name="llamar" value="Frecuentemente" id="llamar4" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group-wrapper">
                        <div class="btn-group-row">
                            <?php for ($i = 1; $i <= 10; $i++) { ?>
                                <input type="radio" class="btn-check" name="escala" value="<?= $i ?>" id="escala<?= $i ?>" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group-wrapper">
                        <div class="btn-group-row">
                            <input type="radio" class="btn-check" name="servicio" value="Muy insatisfecho" id="servicio1" autocomplete="off">
                            <label class="btn btn-outline-primary" for="servicio1">Muy insatisfecho</label>

                            <input type="radio" class="btn-check" name="servicio" value="Insatisfecho" id="servicio2" autocomplete="off">
                            <label class="btn btn-outline-primary" for="servicio2">Insatisfecho</label>

                            <input type="radio" class="btn-check" name="servicio" value="Neutro" id="servicio3" autocomplete="off">
                            <label class="btn btn-outline-primary" for="servicio3">Neutro</label>

                            <input type="radio" class="btn-check" name="servicio" value="Satisfecho" id="servicio4" autocomplete="off">
                            <label class="btn btn-outline-primary" for="servicio4">Satisfecho</label>

                            <input type="radio" class="btn-check" name="servicio" value="Muy satisfecho" id="servicio5" autocomplete="off">
