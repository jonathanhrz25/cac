            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../graficas/graficaEncuesta.php?ruta=19" class="btn btn-outline-primary btn-lg btn-block">
                            Graficas Ruta 19
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../encuestas/index19.php?ruta=19" class="btn btn-outline-primary btn-lg btn-block">
                            Encuesta Ruta 19
                        </a>
                    </div>
                </div>
