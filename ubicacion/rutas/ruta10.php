            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../graficas/graficaEncuesta.php?ruta=10" class="btn btn-outline-primary btn-lg btn-block">
                            Graficas Ruta 10
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../encuestas/index10.php?ruta=10" class="btn btn-outline-primary btn-lg btn-block">
                            Encuesta Ruta 10
                        </a>
                    </div>
                </div>
