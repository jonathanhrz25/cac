<?php
// Este archivo es generado dinámicamente
// Ruta 3
?>
<?php
            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../graficas/graficaEncuesta.php?ruta=03" class="btn btn-outline-primary btn-lg btn-block">
                            Graficas Ruta 3
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../encuestas/index3.php?ruta=03" class="btn btn-outline-primary btn-lg btn-block">
                            Encuesta Ruta 3
                        </a>
                    </div>
                </div>
