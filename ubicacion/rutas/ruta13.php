            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../graficas/graficaEncuesta.php?ruta=13" class="btn btn-outline-primary btn-lg btn-block">
                            Graficas Ruta 13
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../encuestas/index13.php?ruta=13" class="btn btn-outline-primary btn-lg btn-block">
                            Encuesta Ruta 13
                        </a>
                    </div>
                </div>
