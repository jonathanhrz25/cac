            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../graficas/graficaEncuesta.php?ruta=14" class="btn btn-outline-primary btn-lg btn-block">
                            Graficas Ruta 14
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../encuestas/index14.php?ruta=14" class="btn btn-outline-primary btn-lg btn-block">
                            Encuesta Ruta 14
                        </a>
                    </div>
                </div>
