            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../graficas/graficaEncuesta.php?ruta=16" class="btn btn-outline-primary btn-lg btn-block">
                            Graficas Ruta 16
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../encuestas/index16.php?ruta=16" class="btn btn-outline-primary btn-lg btn-block">
                            Encuesta Ruta 16
                        </a>
                    </div>
                </div>
