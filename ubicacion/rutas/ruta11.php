            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../graficas/graficaEncuesta.php?ruta=11" class="btn btn-outline-primary btn-lg btn-block">
                            Graficas Ruta 11
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="../encuestas/index11.php?ruta=11" class="btn btn-outline-primary btn-lg btn-block">
                            Encuesta Ruta 11
                        </a>
                    </div>
                </div>
