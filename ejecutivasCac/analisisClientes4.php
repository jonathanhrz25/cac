            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes4 WHERE relacion_otro = '$categoria'";
        ...
        <script>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes4 WHERE inactividad LIKE '%$categoria%'";
                        $resultCategoria = mysqli_query($conn, $sqlCategoria);
                        $rowCategoria = mysqli_fetch_assoc($resultCategoria);
                        echo "['$categoria', " . $rowCategoria['total'] . "],";
                    }
        ...
        <script>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes4 WHERE alta_relacion = '$categoria'";
                        $resultCategoria = mysqli_query($conn, $sqlCategoria);
                        $rowCategoria = mysqli_fetch_assoc($resultCategoria);
                        echo "['$categoria', " . $rowCategoria['total'] . "],";
                    }
                ...
                var options = {
                    title: 'Cantidad de Clientes por Calificación de pregunta: 3. ¿Le interesaría seguir trabajando con su cuenta o a través de la cuenta relacionada?',
                    is3D: true,
                };
        ...
        <script>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ['Calidad de Servicio', 'Cantidad'],
                    <?php
                    $categorias = ["Si", "No", "Si, con Credito"];
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes4 WHERE relacion_com = '$categoria'";
                        $resultCategoria = mysqli_query($conn, $sqlCategoria);
                        $rowCategoria = mysqli_fetch_assoc($resultCategoria);
                        echo "['$categoria', " . $rowCategoria['total'] . "],";
                    }
