    ...
    <header>
        <nav class="navbar navbar-dark bg-dark fixed-top"
            ...
            <div class="container-fluid">
                <a class="navbar-brand text-white" href="../verificar/menu1.php">
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-md-6 mx-auto">
                        <a href="../ejecutivasCac/verResultados3.php" class="btn btn-outline-primary btn-lg btn-block">
                            Resultados de Encuestas
                        </a>
                    </div>
                    <div class="col-md-6 mx-auto">
                        <a href="../ejecutivasCac/analisisClientes3.php"
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6 mx-auto">
                            <a href="../index3.html" class="btn btn-outline-primary btn-lg btn-block" target="_blank">
                                Encuesta
                            </a>
                        </div>
                    </div>
