...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
            <a class="navbar-brand" href="../ejecutivasCac/bloque2.php">
    ...
    <body style="padding-top: 40px;">
        ...
        <div id="piechart_3d_1" style="width: 1000px; height: 550px;"></div>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes2 WHERE relacion_otro = '$categoria'";
                ...
                var options = {
                    title: 'Cantidad de Clientes por Calificación: ¿Tiene relación con otro cliente?',
                    is3D: true,
                };
        ...
        <script>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    $categorias = ["Si", "No"];
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes2 WHERE negocio = '$categoria'";
                        $resultCategoria = mysqli_query($conn, $sqlCategoria);
                        $rowCategoria = mysqli_fetch_assoc($resultCategoria);
                        echo "['$categoria', " . $rowCategoria['total'] . "],";
                    }
        ...
        <script>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes2 WHERE inactividad LIKE '%$categoria%'";
                        $resultCategoria = mysqli_query($conn, $sqlCategoria);
                        $rowCategoria = mysqli_fetch_assoc($resultCategoria);
                        echo "['$categoria', " . $rowCategoria['total'] . "],";
                    }
        ...
        <script>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ['Calidad de Servicio', 'Cantidad'],
                    <?php
                    $categorias = ["Se queda con su cuenta", "Trabajará a través de la cuenta relacionada", "Trabajaran en ambas cuentas"];
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes2 WHERE alta_relacion = '$categoria'";
                        $resultCategoria = mysqli_query($conn, $sqlCategoria);
                        $rowCategoria = mysqli_fetch_assoc($resultCategoria);
                        echo "['$categoria', " . $rowCategoria['total'] . "],";
                    }
                ...
                var options = {
                    title: 'Cantidad de Clientes por Calificación de pregunta: 4. ¿Le interesaría retomar la relación comercial con Serva con su cuenta o prefiere trabajar a través de la cuenta relacionada?',
                    is3D: true,
                };
        ...
        <script>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    $categorias = ["Si", "No"];
                    foreach ($categorias as $categoria) {
                        $sqlCategoria = "SELECT COUNT(*) as total FROM form_clientes2 WHERE relacion_com = '$categoria'";
                        $resultCategoria = mysqli_query($conn, $sqlCategoria);
                        $rowCategoria = mysqli_fetch_assoc($resultCategoria);
                        echo "['$categoria', " . $rowCategoria['total'] . "],";
                    }
                ...
                var options = {
                    title: 'Cantidad de Clientes por Calificación de pregunta: 5. ¿Le interesaría retomar la relación comercial con Serva?',
                    is3D: true,
                };
