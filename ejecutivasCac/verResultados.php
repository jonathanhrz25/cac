...
<body>
    ...
    <body style="padding-top: 70px;">
        ...
        if (isset($_GET['enviar'])) {
            ...
            $sql = "SELECT * FROM form_clientes WHERE (num_cliente LIKE '%$busqueda%')";
        ...
        $sql_paginacion = "SELECT * FROM form_clientes WHERE (num_cliente LIKE '%$busqueda%') LIMIT $indice_inicio, $resultados_por_pagina";
        ...
        <body style="padding-top: 100px;">
            ...
            $sql_total_resultados = "SELECT COUNT(*) as total FROM form_clientes WHERE (num_cliente LIKE '%$busqueda%')";
