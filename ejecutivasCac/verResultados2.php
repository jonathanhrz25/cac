...
<body>
    ...
    <body style="padding-top: 70px;">
        ...
        if (isset($_GET['enviar'])) {
            ...
            $sql = "SELECT * FROM form_clientes2 WHERE (num_cliente LIKE '%$busqueda%')";
        ...
        $sql_paginacion = "SELECT * FROM form_clientes2 WHERE (num_cliente LIKE '%$busqueda%') LIMIT $indice_inicio, $resultados_por_pagina";
        ...
        <body style="padding-top: 100px;">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead class="thead" style="background-color: #d63384!important;">
                            <tr>
                                <th>Id</th>
                                <th>Indicar si tiene relación con otro cliente</th>
                                <th>No. de cliente</th>
                                ...
                                <th>4. Notamos que hay otra cuenta dada de alta con nosotros relacionada a usted ¿Le interesaría retomar la relación comercial con Serva con su cuenta o prefiere</th>
                                <th>5. ¿Le interesaría retomar la relación comercial con Serva?</th>
                            </tr>
                        </thead>
                        <?php
                        while ($mostrar = mysqli_fetch_array($result_paginacion)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo $mostrar['situacion'] ?></td>
            ...
            $sql_total_resultados = "SELECT COUNT(*) as total FROM form_clientes2 WHERE (num_cliente LIKE '%$busqueda%')";
            ...
            <div class="text-center">
                <a href="descargar2.php" class="btn btn-primary">Descargar Excel</a>
            </div><br><br><br><br>
