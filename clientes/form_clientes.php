...
<body>
    ...
    <div class="container" style="padding-top: 70px;">
        <form class="formulario" method="POST" action="database_form_clientes.php">
            <div class="container col-md-12 col-12 mx-auto">
                ...
                <div id="formularioCompleto">
                    <div class="form-group">
                        <label for="Pregunta4">2. ¿Cuál es el motivo de su inactividad de compra con nosotros? Es posible seleccionar más de una opción.</label><br>
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">3. De acuerdo a la respuesta anterior, colocar la situación presentada con Serva en caso de que aplique.</label>
                        <textarea class="form-control" name="situacion" id="situacion" rows="3"
                            placeholder="Escriba la situación presentada"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="Pregunta6">4. ¿Le interesaría retomar la relación comercial con Serva?</label><br>
