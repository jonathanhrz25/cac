...
$sql = "INSERT INTO form_clientes3 (num_cliente, nombre, negocio, inactividad, otroTexto, situacion, relacion_com)
...
if ($insertar) {
    echo "<script> alert('Sus datos han sido registrados');
            window.location ='guardado3.php';</script>";
} else {
    echo "<script> alert('ERROR sus datos NO han sido registrados');
            window.location ='form_clientes3.php';</script>";
}
