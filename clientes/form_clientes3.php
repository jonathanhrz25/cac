...
<body>
    <header>
        <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #003da6!important;">
            <div class="container-fluid">
                <a class="navbar-brand text-white" href="../index3.html">
    ...
    <div class="container" style="padding-top: 70px;">
        <form class="formulario" method="POST" action="database_form_clientes3.php">
            <div class="container col-md-12 col-12 mx-auto">
                ...
                <div class="subtitulo">
                    <p>
                        ...
                        estan clasificados como Silver Cash, el objetivo es conocer sus necesidades y buscar retomar la
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group-row">
                            ...
                            <div class="btn-group-row">
                                ...
                                <input type="checkbox" class="btn-check" name="inactividad[]" id="inactividad17" value="Se le quito el Crédito">
